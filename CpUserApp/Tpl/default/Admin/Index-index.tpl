						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									{cp:@adminNAME}您好，欢迎进入<strong class="green">{cp:&WEB_NAME} 管理后台</strong>，上次登录IP：{cp:@lastloginip}，上次登录时间：{cp:$Think.session.lastlogindate|date="Y-m-d H:i:s",###}
								</div>
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/avatars/avatar4.png" />
															</div>
...
<![endif]-->
		...
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/jquery.ui.touch-punch.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/jquery.slimscroll.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/jquery.easy-pie-chart.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/jquery.sparkline.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/flot/jquery.flot.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/flot/jquery.flot.pie.min.js"></script>
		<script src="{cp:*WEB_PUBLIC_PATH}/Skin/admin/js/flot/jquery.flot.resize.min.js"></script>

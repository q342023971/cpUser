                ...
                <div class="box-content">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th>操作</th>
                            <th>IP</th>
							<th><i class="glyphicon glyphicon-time"></i> 时间</th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            <td>{cp:$vo.id}</td>
                            <td class="center">{cp:$vo.username}</td>
                            <td class="center">【{cp::L('DB_SYSTEM_LOGS_ACTION_'.$vo['action'])} {cp::L($vo['type'])}】{cp::L('MODEL_USER_'.$vo['return'])}</td>
                            <td class="center"><span class="label-default label">{cp:$vo.ip}</span></td>
							<td class="center">{cp:$vo.time|date="Y-m-d H:i:s",###}</td>
                        </tr>
						</volist>
						<else />
                        <tr>

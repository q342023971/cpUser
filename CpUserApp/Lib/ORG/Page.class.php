...
class Page extends Think {
    ...
    public function show() {
        ...
        if ($upRow>0){
            $upPage="<a href=\"".$url."&".$p."=$upRow\" class=\"btn btn-default\">上一页</a>";
        }else{
            $upPage="";
        }

        if ($downRow <= $this->totalPages){
            $downPage="<a href=\"".$url."&".$p."=$downRow\" class=\"btn btn-default\">下一页</a>";
        }else{
            $downPage="";
        }
        // << < > >>
        if($nowCoolPage == 1){
            ...
            $theFirst = "<a href=\"".$url."&".$p."=1\" class=\"btn btn-default\">".$this->config['first']."</a>";
        }
        if($nowCoolPage == $this->coolPages){
            ...
            $theEnd = "<a href=\"".$url."&".$p."=$theEndRow\" class=\"btn btn-default\">".$this->config['last']."</a>";
        }
        // 1 2 3 4 5
        $linkPage = "";
		...
		for($i=0;$i<$this->rollPage;$i++){
			...
			if($page!=$this->nowPage){
                if($page<=$this->totalPages){
                    $linkPage .= "<a href=\"".$url."&".$p."=$page\" class=\"btn btn-default\">".$page."</a>";
                }else{
                    break;
                }
            }else{
